...
- (void)layoutSubviews {
  ...
  _separatorView.frame = CGRectMake(0.f, self.frame.size.height - height,
                                    self.frame.size.width * 0.9, height);
}
...
- (void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated {
  // if (highlighted)
  //  self.textLabel.textColor = [UIColor colorWithRed:0.f green:0.5 blue:1.f
  //  alpha:1.f];
  // else
